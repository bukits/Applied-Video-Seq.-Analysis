...
//No parameter changes here, GoTo Kalman.cpp
...
int main(int argc, char ** argv)
{
	...
	std::string inputvideo = "/home/avsa/Documents/dataset_lab3/lab3.2/video2.mp4";
	...
	const Size opening_size = Size(3 ,15);
	const Size closing_size = Size(1, 1);// unused
	const MorphShapes type = MORPH_RECT;
	int history = 50;
	double varThreshold = 10;
	int min_width = 20;
	int min_height = 10;
	int connectivity = 8;
	...
	for (int i = 0; true; i++) {
    	...
    	ShowManyImages(label, 4, frame, path, mask, opened);
