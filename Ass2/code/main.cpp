...
//		// "/home/avsa/datasets/...
		string dataset_path = "/home/avsa/AVSA2020datasets/Dataset_Lab2"; //SET THIS DIRECTORY according to your download
		...
		string baseline_seq[3] = {"VISOR/visor_Video01.avi", "PETS2006/PETS2006_S4/PETS2006_S4_C3.avi", "ETRI/ETRI_od_A.avi"};
	...
	//	string image_path = ""; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
		...
		for (int c=0; c<NumCat; c++ )
		{
			...
			for (;;) {
				...
				int min_width=5;  // to set properly
				int min_height=5; // to set properly
