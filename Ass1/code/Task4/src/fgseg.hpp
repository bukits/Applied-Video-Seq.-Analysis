...
namespace fgseg {
	...
	public:
		...
		bgs(double threshold, bool rgb, bool selective_update, double alpha, int ghosts_threshol, double alpha_sh, double beta_sh, double saturation_th, double hue_th);
