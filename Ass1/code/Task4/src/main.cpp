...
// if (argc==3)	{input=argv[3]);}
	...
	string project_name = "Task4"; // project exe name
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			fgseg::bgs avsa_bgs(tau, rgb, selective_bkg_update, alpha, threshold_ghosts2, alpha_sh, beta_sh, saturation_th, hue_th); //construct object of the bgs class
